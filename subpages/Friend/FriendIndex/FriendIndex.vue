<template>
	<tm-fullView>
		...
		<tm-row>
			...
			<tm-col :grid="8">
				<tm-segTabs :gutter="10" round="0" :list="list" fontSize="s" activeFontColor="primary" v-model="active"
		...
		<view class="shadow-24 " v-if="!flag">
	...
	export default {
		...
		data() {
			return {
				...
				incomePlanList: [],
				list_1: [
					{ iconSize: 46, icon: 'icon-home', value: '首页', path: '/pages/youngster/Index/Index' },
